 ...
 */
public class ShenPiAdapter extends BaseListAdapter<ApplyItem> {
    private LayoutInflater inflater;
    public ShenPiAdapter(Activity context) {
        super(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView==null){
            convertView = inflater.inflate(R.layout.item_shenpi_list,null);
        ...
        if (item!=null){
            ...
            switch (item.shenpistatus){
                case 0:
                    holder.tvShenPiState.setText("待审批");
                    break;
                case 1:
                    holder.tvShenPiState.setText("审批通过");
                    break;
                case 2:
                    holder.tvShenPiState.setText("审批不通过");
                    break;
            }

            switch (item.dingdanStatus){
                case 1:
                    holder.tvApplyState.setText("待审批");
                    break;
                case 2:
